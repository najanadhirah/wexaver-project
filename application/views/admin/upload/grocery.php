...
<div class="portlet-title">
    <div class="caption">
        ...
        <span class="caption-subject font-green-meadow bold uppercase">Grocery Brand Upload</span>
    </div>
    <div class="actions">
...
<div class="portlet-body form form-horizontal">
    <!-- BEGIN FORM-->
    <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>index.php/upload/groceryUpload" >
