...
<div class="portlet-body form form-horizontal">
    <!-- BEGIN FORM-->
    <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>index.php/upload/monthlyUpload" >
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input type="file" id="exampleInputFile1" accept="application/zip" name="upload" required>
    ...
    <!-- END FORM-->
    <p><a class="text-danger" href="<?php echo base_url()?>upload/master">Master Upload</a></p>