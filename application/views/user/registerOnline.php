                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-red bold uppercase"> Register Membership -
                                                <span class="step-title"> Online </span>
                                            </span>
                                        </div>
                                        <div class="actions">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane active" id="tab1">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Siti Nurhaliza binti Tarudin"  required/>
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control" name="ic" id="ic" placeholder="888888-88-8888" required/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control" name="email" id="email" placeholder="alias@gmail.com" required/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control" name="phone" id="phone" minlength="10" maxlength="11" placeholder="012-3456789" required/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="password" class="form-control" name="password" id="submit_form_password" placeholder="******" required/>
                                                        ...
                                                        <div class="tab-pane" id="tab2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <select name="average" id="average_list" class="form-control" required>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control" name="city" id="city" placeholder="Sepang" required/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control" name="postcode" id="postcode" placeholder="12345" required/>
                                                        ...
                                                        <div class="tab-pane" id="tab3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" class="form-control" id="vmodel" name="vmodel" placeholder="Toyota Vios" required/>
