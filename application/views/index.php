...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
    ...
    <div class="carousel-item" style="max-height: 750px;">
      <img class="d-block w-100 h-80" src="../assets/home/images/header.jpg" alt="Promotion2" >
      <div class="carousel-caption d-none d-md-block" >
...
<!--         <div class="card-header"> Ganjaran Tunai 20% Insurans Kenderaan</div> -->
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="card col-sm-4" style="border: transparent;" align="center">
                ...
                <h4 class="card-title" style="padding-top: 2%">Insuran Kenderaan</h4>
              </div>
            </div>
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <center>
                  <img class="d-block w-90" src="../assets/home/images/ganjaran1.png" style="height: 80%; width: 80%;" >
                  </center>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                 ...
                 <div class="form-group row">
                   <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Jumlah Perbelanjaan (RM)</label>
                   <div class="col-sm-6">
                 ...
                 <button type="button" class="btn btn-lg btn-outline-success" onclick="calcpayments()">KIRA</button>
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collap collapse" aria-labelledby="headingTwo" data-parent="#accordion">
      ...
      <div class="card-body">
            <h5 class="card-title">Dapatkan Ganjaran Tunai 30 sen Setiap Barang</h5>
              <div class="row">
                <div class="card col-sm-4" style=" border: transparent;">
                  <br>
                  <i class="fa fa-users" style="font-size:68px;color:black"></i>
    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <center><span>
          ...
          <div class="caption">
            <br>
            <p align="center" class="card-text mbr-section-text text-1 mbr-editable-content" style="font-size: 20px;">​​Sumbangan khairat kematian akibat kemalangan<br>RM11,500</p>
          </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          ...
          <div class="caption"><br>
            <p align="center" class="card-text mbr-section-text text-1 mbr-editable-content" style="font-size: 20px;">​​Sumbangan ketidakupayaan kekal akibat kemalangan<br>RM10,000</p>
          </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          ...
          <div class="caption"><br>
            <p align="center" class="card-text mbr-section-text text-1 mbr-editable-content" style="font-size: 20px;">​​Sumbangan khairat kematian biasa<br>RM1,200</p>
          </div>
      </div>
    </div>
  </div>
...
<div class = "container">
    <div class = 'row'>
        <div class="col-md-4">
            <div class="thumbnail">
              ...
              <div class="caption"><br>
                <p align="center" class="card-text mbr-section-text text-1 mbr-editable-content">​​Sumbangan caj ambulan akibat kemalangan<br>RM350</p>
              </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="thumbnail">
              ...
              <div class="caption"><br>
                <p align="center" class="card-text mbr-section-text text-1 mbr-editable-content">​​Ganti rugi musibah ragut<br>RM300</p>
              </div>
            </div>
        </div>
        <div class="col-md-4">
          <div class="thumbnail">
              ...
              <div class="caption"><br>
                <p align="center" class="card-text mbr-section-text text-1 mbr-editable-content">Elaun harian hospital akibat kemalangan<br>RM30</p>
              </div>
          </div>
        </div>
    </div>
 ...
 <div class="card-body">
    ...
    <span class="square border border-secondary"><img class="img1" src="../assets/home/images/lifebouy.png" style="width:200px; height: 130px;"></span>
  ...
  <div class="card-body" >
      ...
      <img class="img1 border border-secondary" src="../assets/home/images/matdespatche.png" style="width:200px; height: 200px">
