...
/* Register Offline */
        $('#off-submit-btn').click(function(event){
        event.preventDefault ? event.preventDefault() : (event.returnValue = false);

        $("#off-submit-btn").prop('disabled',true);
        $("#reg_error").html('');
        $("#off-submit-btn").html('<i class="fa fa-spinner fa-pulse fa-fw margin-bottom"></i><span class="sr-only">Signing...</span>');
        ...
        $.post("/index.php/register/ajaxOffline",
        {
            fullname        : fullname,     
            ic          : ic,
            email           : email,
        ...
        function(data,status){
            $("#off-submit-btn").html('Submit');
            $("#off-submit-btn").prop('disabled',false);
